# Yin-Yang Fractal Unified Field Theory

There is only one entity in the universe — the energy particle; only one form of motion — spiral motion; only one set of rules — the Luoshu lattice.
...
Free reading and downloading are permitted.
Modification, rewriting or commercial use without authorization is prohibited.
